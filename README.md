...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/BJ2sTYBWUW)
...
Generate Stories for the Component

```sh
nx g @nx/react:stories --project=ui-components
```
